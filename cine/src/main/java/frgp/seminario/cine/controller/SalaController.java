...
public class SalaController {
	...
	public ModelAndView borrar(@RequestParam("id") Long id, Principal principal)
	{
		...
		//========================================
		if(!logicaNegocio.isReservaActivaSala(logicaNegocio.get(id))){
			...
			mav.getModelMap().addAttribute("message",  new Message("Error al desactivar sala, hay un reserva activa", Type.SUCCESS));
