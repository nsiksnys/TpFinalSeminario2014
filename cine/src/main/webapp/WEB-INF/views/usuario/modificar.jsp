		...
		<form:form class="form" action="guardar" method="post">
			<fieldset>
		        ...
		        <div class="form-group">
		            ...
		            <div class="form-group">
		                <form:input path="fechaNacimiento" class="form-control" cssErrorClass="form-control" id="fechaNacimiento" placeholder="dd/mm/aaaa"/>
		        ...
		        <div class="form-group">
		            ...
		            <div class="form-group">
		                <form:input path="preguntaSeguridad" class="form-control" cssErrorClass="form-control" id="preguntaSeguridad"/>
		        ...
		        <div class="form-group">
		            ...
		            <div class="form-group">
		                <form:input path="respuestaSeguridad" class="form-control" cssErrorClass="form-control" id="respuestaSeguridad"/>
